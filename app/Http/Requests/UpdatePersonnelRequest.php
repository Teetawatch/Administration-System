...
/**
 * Form Request for updating an existing Personnel record.
 * 
...
class UpdatePersonnelRequest extends FormRequest
{
    ...
    {
        $personnelId = $this->route('personnel')?->id ?? $this->route('personnel');

        return [
            'employee_id' => "required|string|unique:personnel,employee_id,{$personnelId}",
